...
new Vue({
    ...
    methods: {
        ...
        searchData: function searchData(key) {
            ...
            this.tagsFadeOut();
            axios.get('/data/search?key=' + key).then(function (res) {
                _this2.data = res.data;
            }).catch(function (err) {
                throw err;
            });
        },
        getTagData: function getTagData(cb) {
            var _this3 = this;

            axios.get('/data/search/ad_tabs').then(function (res) {
                _this3.tagData = res.data;
                cb && cb();
            }).catch(function (err) {
                throw err;
            });
        ...
        tagsFadeOut: function tagsFadeOut() {
            this.hide = {
                display: 'none'
            };
            this.fadeIn = {
